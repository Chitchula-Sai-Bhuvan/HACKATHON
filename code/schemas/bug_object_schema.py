...
class BugObject(BaseModel):
    ...
    summary: Optional[str] = Field(None, description="Short 1-line summary of the bug")
    ...
    bug_signature: Optional[str] = Field(None, description="The unique signature of the bug pattern")
